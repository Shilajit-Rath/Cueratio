...
The output sheet count varies with the source: roughly 38 fixed sheets plus one extra
sheet for every benefit type that appears in the input (Wellness Bonus, Maturity
Benefit, Loyalty Bonus, Death Benefit, TPD, Waiver of Premium, etc.).

## Styling (non-negotiables, baked into the script)

- **All fonts:** Arial, size 10.
- **Headers:** bold, 25% grey fill (`#BFBFBF`).
- **Borders:** none, anywhere.
...
|-------|---------|----------------|
| `00_Index` | Summary with full sheet inventory (including per-benefit sheets) | – |
...
| `29_Misc_&_Extra_Benefits` | Summary of all extra benefits | **Strong** |
| `30–32` | Deductible / Copay / NCB | NA |
| `33+` | **One sheet per benefit type** (Death Benefit, TPD, Waiver of Premium, Hospital Income, Wellness Bonus, Maturity Benefit, etc.) — only created when at least one product has data for that benefit | **Strong** |
